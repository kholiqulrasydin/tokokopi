class AlertProvider{
    ...
    closeAlert(){
        var alertTagElement = document.getElementById('myModal');
        var alertStyle = document.getElementById('alert-style');
